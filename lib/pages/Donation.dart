...
void handlerExternalWallet(){
  ...
  void openCheckout(){
    var options = {
      "key" : "rzp_test_suXt8b3uI6XRKA",
      "amount" : num.parse(textEditingController.text)*100 ,
      "name" : "Anshul Kumar",
      "description" : "Donation for Book_Space",
      "prefill" : {
        "contact" : "9456862963",
        "email" : "anshulkumar3552@gmail.com",
      },
      "external" : {
        "wallet" : ["paytm"]
      }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Center(child: Image(image: AssetImage("images/Logo_Bg.png"), height: 200,width: 200,)),
              SizedBox(
                height: 20,
              ),
              TextField(
  ...
  child: Wrap(
    ...
    children: [
      ...
      ListTile(
        ...
        onTap: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (builder) => const HelpPage()));
        },
      ),
